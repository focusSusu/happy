...
<section class="content-header clearfix">
    <span class="con-header-tit">编辑活动</span>
</section>
...
<div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <div class="layui-input-inline">
                <select name="type" lay-verify="required" lay-search=""  class="form-control">
                    ...
                    <option value="<?=$v['keys'] ?>" <?php if($v['keys'] == $list['type']): ?> selected  <?php endif; ?>><?=$v['vals'] ?></option>
                    <?php endforeach; ?>
                </select>
            </div>        </div>
    </div>
        ...
        <div class="col-sm-8">
            <div class="layui-upload">
                ...
                <div class="layui-upload-list">
                    <img class="layui-upload-img" src="<?= $list['img_url'] ?>" id="demo1" width="100px">
                    <p id="demoText"></p>
                </div>
            </div>
            <input type="hidden" name="img_url" class="form-control" value="<?= $list['img_url'] ?>" id="" placeholder="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <?php if($list['is_valid_time'] == 1): ?>
                    value="<?=$list['valid_start_time'] ?>  -  <?=$list['valid_end_time'] ?>"
                   <?php endif; ?>
            >
        </div>
    </div>
...
<!--    </div>-->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="radio" name="link_type" value="2" title="小程序地址"  class="to-url" onchange="" <?php if($list['link_type'] == 2): ?>checked="" <?php endif; ?>>小程序地址
            <input type="radio" name="link_type" value="1" title="H5地址" class="to-url" <?php if($list['link_type'] == 1): ?>checked="" <?php endif; ?>>H5地址
            <input type="radio" name="link_type" value="0" title="不跳转" class="to-url" <?php if($list['link_type'] == 0): ?>checked="" <?php endif; ?>>不跳转
    ...
    <div class="weapp">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" name="app_id" class="form-control" id="name" placeholder="" value="<?= $list['app_id']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" name="app_url" class="form-control" id="name" placeholder="" value="<?= $list['app_url']?>">
            </div>
        </div>
    </div>
    ...
    <div class="form-group link-url">
        ...
        <div class="col-sm-8">
            <input type="text" name="link_url" class="form-control" id="name" placeholder="" value="<?=$list['link_url'] ?>">
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var category_type = $("input[name='link_type']:checked").val();
    ...
    $("#sub").click(function () {
        ...
        var url = "<?= base_url()."banner/updateBanner/" ?>";
        $.ajax({
            type:"post",
            url:url,
            processData:false,
