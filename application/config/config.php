...
|
*/
$config['base_url'] = 'http://www.happy.com';
...
|
*/
$config['log_path'] = 'application/logs/ci_log/';
...
$config['sess_cookie_name'] = 'lamer_session';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = '/data/html/www/lamer/pc/application/session';
...
$config['pagination']['first_link'] = '第一页';
$config['pagination']['last_link'] = '最后页';
...
$config['pagination']['cur_tag_open'] = '<li><a href=" "><b style="color:#45ac61">';
$config['pagination']['cur_tag_close'] = '</b></a ></li>';
