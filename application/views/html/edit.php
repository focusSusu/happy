            ...
            <form class="form-horizontal">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="checkbox">
                      <label>
                        <input type="checkbox"> 课程管理
                      </label>
                      <label>
                        <input type="checkbox"> 标签管理
                      </label>
                      <label>
                        <input type="checkbox"> 活动管理
                      </label>
                      <label>
                        <input type="checkbox"> 专家管理
                      </label>
                    </div>
                  </div>
              </div>
              <div class="btn_footer">
                  <button type="button" class="btn btn-primary" a-click="postData">确定</button>
