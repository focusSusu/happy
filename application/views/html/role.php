  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header clearfix">
        <span class="con-header-tit">角色管理</span>
      </section>
      <!-- Main content -->
              ...
              <div class="col-xs-10">
                  <div class="form-inline navbar-form navbar-left" >
                      <div class="form-group">
                        <label class="control-label" for="brang_id">用户名:</label>
                        <input type="text" class="form-control" value="" >
                      </div>
                      <button type="button" class="btn btn-default" i-click="search">筛选</button>
                    </div>
              </div>
              <div class="col-xs-2">
                  <div class="form-inline navbar-form navbar-left" >
                      <div class="form-group ">
                        <a href="edit.html">
                          <button type="button" class="btn btn-primary" i-click="search">添加角色</button>
                        </a>
                      </div>
                    </div>
              </div>
